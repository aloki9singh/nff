...
export const AuthContextProvider = ({ children }) => {
  ...
  React.useEffect(() => {
    ...
    const unsubscribeUserProfile = onSnapshot(doc(db, "allusers", user.uid), (doc) => {
      if (doc.exists()) {
  ...
  return (
    <AuthContext.Provider value={{ user, loading, userProfile, joinedCourses }}>
      {loading ? <div className="w-full text-center flex items-center justify-center h-screen ">Loading...</div> : children}
