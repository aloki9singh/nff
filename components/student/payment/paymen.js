...
const Payment = ({ updatePage, updatePrice }) => {
  ...
  return (
    <>
      <div
        className={` ${showToast ? "blur-lg" : null
          }`}
      >
        {showToast && (
          <ToastMessage
        ...
        <div className="w-full bg-[#0D0E14] ">
          ...
          <div className=" myClass flex flex-col items-center text-white font-Inter">
            <ChoosePlan
