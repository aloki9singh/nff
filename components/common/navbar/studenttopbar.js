...
const StudentTopbar = ({ heading }) => {
  ...
  return (
    <>
      <div className="flex justify-between lg:flex  md:static static md:w-[95%] md:bg-[#2E3036]  md:ml-5  top-0 md:rounded-l-[25px] mt-4   w-full p-2 md:p-0">
