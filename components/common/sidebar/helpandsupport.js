...
const HelpAndSupportSidebar = ({ toggleSideBar }) => {
	...
	return (
		<>
			<aside className="sticky top-0 left-0 min-h-screen h-screen md:bg-[#141518] bg-[#25262C] p-5 rounded-l-[40px] md:rounded-l-[0px]  flex flex-col justify-between w-[214px] overflow-scroll">
				<div>
					<div>
						<Image
