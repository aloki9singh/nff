...
const MentorCard = ({name, designation}) => {
  return (
    <div className="h-full w-[85px] md:w-[291px] relative rounded-10 overflow-hidden border-2 border-white flex justify-center items-end">
      <Image src="/componentsgraphics/mentor/mentorcard/mentorpfpsample.svg" width={291} height={413} className="absolute top-0 left-0 h-full w-full object-cover" alt="Image"/>
