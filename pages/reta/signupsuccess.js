                ...
                <div className='text-center space-y-5 '>
                  ...
                  <div className='m-auto w-full pt-10 pb-5'>
                    ...
                    <div className='md:flex grid  grid-cols-2    text-center justify-around gap-10   m-auto text-sm text-white  '>
                      <div className='bg-[#B26ED3] md:w-[150px] w-[120px] md:h-[200px] h-[150px] rounded m-auto p-2 space-y-2 hover:border-[2px] '>
                      ...
                      <div className='bg-[#B26ED3] md:w-[150px] w-[120px] md:h-[200px] h-[150px] rounded m-auto p-2 space-y-2 flex flex-col justify-around hover:border-[2px]'>
                        <div className='flex justify-center align-middle'>
                          <Image
                            alt='Icon'
                      ...
                      <div className='bg-[#B26ED3] md:w-[150px] w-[120px] md:h-[200px] h-[150px] rounded m-auto p-2 space-y-2 flex flex-col justify-around hover:border-[2px] '>
                        ...
                        <div onClick={() => router.push('addTeam')}>
                          Create Team
                        </div>
                      </div>
                      <div className='bg-[#B26ED3] md:w-[150px] w-[120px] md:h-[200px] h-[150px] rounded m-auto p-2 space-y-2 flex flex-col justify-around hover:border-[2px]'>
