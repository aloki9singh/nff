    ...
    return (
        <div className={`${loading ? "pointer-events-none z-1" : ""}`}>
            ...
            <div className="text-white md:m-10 rounded-[25px] p-10 bg-[#222222]  ">
                ...
                {!edit ? <div className="flex justify-end p-4  text-white mr-16">
                    <button onClick={handleClick} className="w-fit bg-[#505057] p-4 rounded-[10px]">Edit Profile</button>
                </div> :
                    <div className=" flex justify-end text-white mr-16">
                        <button className="w-fit bg-[#E1348B] p-4 rounded-[10px] mr-2" onClick={handleClick}>Save</button>
                        <button className="w-fit bg-[#505057] p-4 rounded-[10px]" onClick={handleClick}>Cancel</button>
                    </div>
                }
                            ...
                            <div className=" grid max-w-full md:max-w-4xl mt-5 justify-between md:grid-cols-2 gap-5">
                                <div className=" grid max-w-full md:max-w-4xl mt-5 justify-between md:grid-cols-2 gap-5">
                                    ...
                                    <div className="block">
                                        ...
                                        <Image src={data?.photoURL} width={100} height={10000}></Image>
                                        {/* <input
                                            value={data?.photoURL || ""}
                                            name="profilephoto"
                                            //  onChange={setData}
                ...
                {edit ? <div className="max-w-full text-right">
                    <button
                        // onClick={detailadd}
