...
export default async function sendEmailMentor(req, res) {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      <a href="http://localhost:3000/meta/signupsuccess?email=${data.email}&key=${verificationKey}" style="display: inline-block; padding: 12px 24px; background-color: #007bff; color: #fff; text-decoration: none;">Verify Email</a>`,
    });
