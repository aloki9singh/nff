                ...
                <div className="max-w-5xl ">
                  ...
                  >
                    ...
                    <p className="w-full md:w-6/12 lg:w-7/12 text-start text-base lg:text-xl font-Inter leading-[150%] tracking-wider">
                      ...
                      latest updates new features and announcements. This
                      section is a great place to stay informed about any
                      changes that may affect your learning experience.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    <p className="w-full md:w-6/12 lg:w-7/12 text-start text-base lg:text-xl font-Inter leading-[150%] tracking-wider">
                      ...
                      emailing us at{" "}
                      <a
                        href="mailto:feedback@neatskills.tech"
                        className="text-pink"
                      >
                        {" "}
                        feedback@neatskills.tech
                      </a>{" "}
