...
const helpandsupport = () => {
	...
	return (
		<div className="flex text-white">
			...
			{/* {(
        <div
          className={`fixed right-0 ${isSidebar ? "block" : "hidden"} w-[281px] h-screen bg-[#25262C]  rounded-l-[40px] z-10`}
        >
          <CourseoverviewSidebar toggleSideBar={toggleSideBar} />
			...
			<div className="min-h-screen  w-full flex flex-col ">
				...
				<div className="h-full w-full bg-[#2D2E35] rounded-bl-[40px]flex flex-col items-center px-4 md:px-10 py-10">
						...
						<div className="max-w-5xl ">
							...
							>
								...
								<p className="w-full md:w-6/12 lg:w-7/12 text-start text-base lg:text-xl font-Inter leading-[150%] tracking-wider">
									...
									registration process, setting up your profile, and exploring
									the available courses and resources.
								</p>
							</div>
							...
							>
								...
								<ul className="w-full md:w-6/12 lg:w-7/12 text-start text-base lg:text-xl list-decimal space-y-1">
									<li className="font-Inter leading-[150%] tracking-wider">
										...
										discover the available courses. You can search by category,
										subject, or use keywords to find specific courses of
										interest.
									</li>
									<li className="font-Inter leading-[150%] ">
										Course Selection: Read the course descriptions and click on
										a course to access more details. Take note of the course
										duration, format, and prerequisites, if any. Make sure the
										course aligns with your learning goals and fits your
										schedule.
									</li>

									<li className="font-Inter leading-[150%] ">
										Create an Account: If you haven't already, create an account
										on our learning platform. Provide the necessary information
										to register, including your name, email address, and
										password. You may also have the option to sign up using your
										social media accounts.
									</li>

									<li className="font-Inter leading-[150%] ">
										Login to Your Account: After creating an account, log in
										using your credentials. This will grant you access to the
										platform's features and allow you to enroll in courses.
									</li>

									<li className="font-Inter leading-[150%] ">
										Enroll in the Course: Once you've chosen a course, click on
										the "Enroll" or "Buy Now" button. If the course is free, you
										may be enrolled immediately. For paid courses, you'll be
										prompted to select a payment method and complete the
										transaction.
									</li>
									...
									<li className="font-Inter leading-[150%] ">
										...
										special offers or promotions. The system will calculate the
										discounted price before finalizing the payment.
									</li>

									<li className="font-Inter leading-[150%] ">
										Confirmation and Access: After successful enrollment, you'll
										receive a confirmation message or email. The course will now
										appear in your enrolled courses or dashboard. Click on the
										course title to access its materials and start your learning
										journey.
									</li>
								</ul>
							</div>
							...
							>
								...
								<p className="w-full md:w-6/12 lg:w-7/12 text-start text-base lg:text-xl font-Inter leading-[150%] tracking-wider">
									If you prefer to communicate via email, you can reach out to
									our support team at support@learningplatform.com. We aim to
							...
							>
								...
								<p className="w-full md:w-6/12 lg:w-7/12 text-start text-base lg:text-xl font-Inter leading-[150%] tracking-wider">
									...
									updates, new features, and announcements. This section is a
									great place to stay informed about any changes that may affect
							...
							>
								...
								<p className="w-full md:w-6/12 lg:w-7/12 text-start text-base lg:text-xl font-Inter leading-[150%] tracking-wider">
									Check out our FAQ section, where we have compiled answers to
									common queries from learners like you. You may find solutions
									to your questions here without the need to reach out to
									support.
								</p>
							</div>
							...
							>
								...
								<p className="w-full md:w-6/12 lg:w-7/12 text-start text-base lg:text-xl font-Inter leading-[150%] tracking-wider">
									...
									. Your thoughts help us improve our services. Thank you for
